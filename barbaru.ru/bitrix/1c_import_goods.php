...
define("SKU_CATALOG_IBLOCK_ID", 4);
define("ARTICLE_CODE", "CML2_ARTICLE");
                        ...
                        if ($base64_encode && $xml_string) {
                            ...
                            if ($node = $xml->SelectNodes('/Товары')) {
                                ...
                                $arFilter = [
                                    ...
                                    "PROPERTY_".ARTICLE_CODE => $articules,
                                ];
                                $arSelect = ["ID", "PROPERTY_".ARTICLE_CODE, 'PROPERTY_DELIVERY_TYPE'];
